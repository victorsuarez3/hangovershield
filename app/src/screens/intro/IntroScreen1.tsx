/**
 * Intro Onboarding Screen 1 - Hangover Shield
 * "Daily guidance made for your body"
 */
...
export const IntroScreen1: React.FC<IntroScreen1Props> = ({ onNext }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.content, { paddingTop: insets.top + 60, paddingBottom: insets.bottom + 32 }]}>
        ...
        <View style={styles.iconContainer}>
          <Ionicons name="person-outline" size={48} color="#0F4C44" />
        </View>

        {/* Title */}
        <Text style={styles.title}>Daily guidance made for your body</Text>

        {/* Subtitle */}
        <Text style={styles.subtitle}>
          Personalized recovery support based on how your body feels each day.
        </Text>
