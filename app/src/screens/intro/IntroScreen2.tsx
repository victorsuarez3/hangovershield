/**
 * Intro Onboarding Screen 2 - Hangover Shield
...
export const IntroScreen2: React.FC<IntroScreen2Props> = ({ onNext }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.content, { paddingTop: insets.top + 60, paddingBottom: insets.bottom + 32 }]}>
        ...
        <View style={styles.iconContainer}>
          <Ionicons name="flask-outline" size={48} color="#0F4C44" />
        </View>

        {/* Title */}
        <Text style={styles.title}>Science-based recommendations</Text>

        {/* Subtitle */}
        <Text style={styles.subtitle}>
          Based on evidence-informed hydration, nutrition, and recovery science.
        </Text>
